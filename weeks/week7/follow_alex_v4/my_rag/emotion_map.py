EMO_MAP = {
    ...
    "E50": "당황", "E51": "고립된", "E52": "남의 시선을 의식하는", "E53": "외로운", "E54": "열등감",
    "E55": "죄책감", "E56": "부끄러운", "E57": "혐오스러운", "E58": "한심한", "E59": "혼란스러운",
    "E60": "기쁨", "E61": "감사하는", "E62": "사랑하는", "E63": "편안한", "E64": "만족스러운",
    "E65": "흥분되는", "E66": "느긋한", "E67": "안도하는", "E68": "신이 난", "E69": "자신하는",
}

POSITIVE = {f"E{i}" for i in range(60, 70)}
NEGATIVE = {f"E{i}" for i in range(10, 60)}
